...
def upgrade():
    ...
    sa.Column('created_at', database.types.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', database.types.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('confirmed_at', database.types.DateTime(timezone=True), nullable=True),
